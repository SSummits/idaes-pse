...
class MEAColumnData(PackedColumnData):
        ...
        def rule_mass_transfer_coeff_vap(blk, t, x, j):
            if x == self.vapor_phase.length_domain.first():
                ...
                return blk.mass_transfer_coeff_vap[t, x, j] == (
                    ...
                    (blk.packing_specific_area / blk.hydraulic_diameter[x]) ** 0.5
                ) * (
                ...
                return (
                    ...
                    * (
                        ...
                        * blk.liquid_phase.properties[t, x].diffus_phase_comp["Liq", j]
                        / (blk.hydraulic_diameter[x] * blk.holdup_liq[t, x])
                    )
                    ** 0.5
                )
    ...
    def initialize(
        ...
        init_log.info_high("Activating Vapor Heat and Enthalpy Balance")
        ...
        init_log.info_high("Activating Liquid Heat and Enthalpy Balance")
